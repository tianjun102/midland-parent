 ...
 */
@Controller
@RequestMapping("/entrust/evaluate")
public class EntrustEvaluateController extends ServiceBaseFilter {
	@Autowired
	...
	Logger logger = LoggerFactory.getLogger(EntrustEvaluateController.class);
	...
	public String toAdd(HttpServletRequest request,Model model) {
		getSelectParam(model);
		settingService.getAllProvinceList(model);
		return "entrustEvaluate/addEntrust";
	}
	@RequestMapping("/add")
	@ResponseBody
	...
	private void getSelectParam(Model model) {
		...
		List<ParamObject> turned = JsonMapReader.getMap("turned");
		model.addAttribute("turneds",turned);
	...
	public String entrustPage(Model model, Entrust record, String pageNo, String pageSize,HttpServletRequest request) throws Exception {
		...
		return "entrustEvaluate/entrustList";
	}
	...
	public String toUpdateAppointment(int entrustId, Model model,HttpServletRequest request) {
		...
		model.addAttribute("pageNo",pageNo);
		model.addAttribute("pageSize",pageSize);
		return "entrustEvaluate/updateEntrust";
	}
	...
	public void userInfoExportExcel(Entrust entrust,HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		entrust.setEntrustType(Contant.ENTRUST_EVALUATE);
