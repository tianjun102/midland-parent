    ...
    <section class="content">
        ...
        <form id="formId" action="${ctx}/rest/activity/addActivity" enctype="multipart/form-data" method="post">
            <ul class="adminfo row">
                <li><span>活动标题：</span><input maxlength="50" type="text" name="actiTitle"><span class="_star ">*</span>
                </li>
                ...
                <li style="overflow:hidden;">
                    ...
                    <textarea style="float:left; width: 92%;min-height: 350px; resize:none; outline-color: #0099e0;"
                              name="actiDetails" id="myEditor" rows="" cols=""></textarea></li>
                <li><span>排序：</span><input maxlength="3" type="text" name="sortOrder"
                ...
                <li style="display:flex;align-items:center">
                    ...
                    <input style="width: 15px;height: 15px;margin: 0px;" onchange="addIsShow();" type="radio"
                           name="isshow" value="1">
            ...
            $.ajax({
                ...
                success: function (result) {
                    if (result.result == "ok") {
                        ...
                        setTimeout(function () {
                            window.open("${ctx}/rest/activity/index", "contentF");
                        }, 2000);
                    }
                },
                error: function (data) {
