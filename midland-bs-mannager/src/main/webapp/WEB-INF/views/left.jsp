        ...
        <dl class="list-left5">
            ...
            <dd>
                ...
                <shiro:hasPermission name="quotationOld">
                    <a id="left22" target="contentF"
                       href="${ctx}/rest/quotationSecondHand/index"><span>二手房信息管理</span></a>
                </shiro:hasPermission>
            </dd>
        </dl>
    </shiro:hasPermission>
        ...
        <dl class="list-left6">
            ...
            <dd>
                ...
                <shiro:hasPermission name="resumeManageEmail">
                    <a id="left28" href="${ctx}/rest/feedbackEmail/index?emailType=2"
                       target="contentF"><span>配置接收邮箱</span></a>
                </shiro:hasPermission>
            </dd>
        </dl>
    </shiro:hasPermission>
        ...
        <dl class="list-left6">
            ...
            <dd>
                ...
                <shiro:hasPermission name="registrationProtocol">
                    <a id="left60" href="${ctx}/rest/siteProtocol/registrationProtocol"
                       target="contentF"><span>注册协议</span></a>
                </shiro:hasPermission>
                <shiro:hasPermission name="registrationProtocol">
    ...
    <shiro:hasPermission name="systemManage">
        <dl class="list-left8">
            ...
            <dd>
                ...
                <shiro:hasPermission name="bottomMenu">
                    <a id="left49" href="${ctx}/rest/menu/bottom/index" target="contentF"><span>底部菜单</span></a>
                </shiro:hasPermission>
                ...
                <shiro:hasPermission name="feedbackEmail">
                    <a id="left57" href="${ctx}/rest/feedbackEmail/index?emailType=1"
                       target="contentF"><span>反馈邮箱</span></a>
                </shiro:hasPermission>
