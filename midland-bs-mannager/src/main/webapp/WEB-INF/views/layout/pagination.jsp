...
<div class="row">
    <div class="col-sm-6">
      ...
      <!-- 每页显示多少记录 --> 
     &nbsp;每页显示： <select style="width: 90px;height: 30px; display:inline-block!important;border-radius: 4px;" name="pageSize" id="pageSize" onchange="setPageSize(${paginator.page},'${target}');">
