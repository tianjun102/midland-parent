    ...
    <form action="${ctx}/rest/appoint/update" method="post" id="appointInfoForm">
        <ul class="userinfo width-md row">
            ...
            <li class="col-md-6"><span>委托时间：</span>
                <input type="text" name="entrustTime" id="entrustTime" disabled="disabled"
                       value="${entrust.entrustTime}" maxlength="50"/>
            </li>
            <li class="col-md-6"><span>联系人：</span>
                <input type="text" name="nickName" id="nickName" value="${entrust.nickName}"
                       onblur="notEmpty('nickName','nickName','')"/>
                <span class="_star">*</span>
            </li>
            <li class="col-md-6"><span>手机号码：</span>
                <input type="text" name="phone" id="phone" value="${entrust.phone}" onblur="checkPhone('','phone','')"
                       maxlength="50"/>
                <span class="_star">*</span>
            </li>
            ...
            <li class="col-md-6"><span>意向小区：</span>
                <input type="text" name="communityName" id="communityName" disabled="disabled"
                       value="${entrust.communityName}" maxlength="50"/>
            </li>
            ...
            <li class="col-md-6"><span>意向面积：</span>
                <input type="text" name="measure" id="measure" disabled="disabled" value="${entrust.measure}"
                       maxlength="50"/>㎡
            </li>
            ...
            <li class="col-md-6"><span>经纪人：</span>
                <input type="text" name="agentName" id="agentName" disabled="disabled" value="${entrust.agentName}"
                       maxlength="50"/>
            </li>
            <li class="col-md-6"><span>处理时间：</span>
                <input type="text" name="handleTime" id="handleTime" disabled="disabled" value="${entrust.handleTime}"
                       maxlength="50"/>
            </li>
            <li class="col-md-11"><span>用户备注：</span>
                <textarea name="remark" id="remark"
                          style="width:calc(100% - 120px);height:50px;resize:none; border: 1px solid #dbe2e6; border-radius: 4px; outline-color: #0099e0;"
                          disabled="disabled"></textarea>
            </li>
            <li class="col-md-11"><span>处理备注：</span>
                <textarea name="dealRemark" id="dealRemark"
...
<c:forEach items="${entrustLogs}" var="s">
    ...
    备注    ：${s.remark}
            ...
            <li class="col-md-6">
                ...
                <a style="margin-left: 20px" class="public_btn bg3" id="cancel" onclick="closeWin12()">取消</a>
            </li>
        </ul>
