    ...
    <form class="login-form" action="rest/user/login" method="post">
        ...
        <div class="form-group">
            ...
            <div class="input-icon">
                ...
                <input name="username" id="username" size="25" value="<%=username %>"
        ...
        <div class="form-group">
            ...
            <div class="input-icon">
                ...
                <input name="password" id="password" size="25" value="<%=password %>"
    ...
    <form class="forget-form" action="rest/user/sendMail" method="post">
        ...
        <div class="form-group">
            ...
            <div class="input-icon">
                ...
                <button type="button" onclick="sendVcode();">获取验证码</button>
