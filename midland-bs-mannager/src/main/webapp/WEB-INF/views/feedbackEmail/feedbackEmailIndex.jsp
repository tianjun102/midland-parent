...
<body>
	...
	<div class="box"> 
		...
		<form action="${ctx }/rest/feedbackEmail/list" method="POST" id="searchForm"
			...
			<input style="margin-left: 20px;width: 70px;height: 28px;line-height: 28px!important;" onclick="window.open('${ctx}/rest/feedbackEmail/export?emailType=${emailType}','contentF')" class = "public_btn bg1" type="submit"  value = "导出"/>
			<div id="listDiv"></div>
		</section>
	</div>
