    ...
    <section class="content">
        ...
        <form id="formId" action="${ctx}/rest/pageConf/add" method="post" enctype="multipart/form-data" method="post">
            ...
            <ul class="adminfo width-lg row">
                <li><span>城市：</span>
                    <select onchange="setCityName();" name="citys" id="citys"
                ...
                <li id="cnzzPc"><span>CNZZ配置：</span>
                    <textarea style="width: 87%;min-height: 250px;resize:none; outline-color: #0099e0;float: left" name="cnzzCode" id="myEditor" rows="" cols=""></textarea></li>
                <li id="cnzzWechat" style="display: none">
                    <span>CNZZ微站配置：</span>
                    <textarea style="width: 87%;min-height: 250px;resize:none; outline-color: #0099e0;float: left" name="cnzzCodeWechat" id="myEditor2" rows="" cols=""></textarea></li>
                <li><span>百度计量状态：</span>
                ...
                <li id="baiduPc"><span>百度计量代码：</span>
                    <textarea style="width: 87%;min-height: 250px;resize:none; outline-color: #0099e0;float: left" name="baiduCode" id="myEditor1" rows="" cols=""></textarea></li>
                <li id="baiduWechat" style="display: none"><span>百度计量微站代码：</span>
                    <textarea style="width: 87%;min-height: 250px;resize:none; outline-color: #0099e0;float: left;" name="baiduCodeWechat" id="myEditor3" rows="" cols=""></textarea>
                </li>
            </ul>
