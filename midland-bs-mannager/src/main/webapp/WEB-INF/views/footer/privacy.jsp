        ...
        <form id="formId" action="${ctx}/rest/banner/addBanner" method="post" enctype="multipart/form-data"
            ...
            <ul class="adminfo row">
                ...
                <li id="textArea" style="display: block;">
                    <textarea style="width: 92%;min-height: 350px;resize:none; outline-color: #0099e0;" name="privacy"
                              id="myEditor" rows="" cols="">${item.privacy}</textarea>
                </li>
                ...
                <ul class="adminfo row">
                    <li>
                        ...
                        <a style="margin-left: 20px" href="${ctx}/rest/privacy/index"  target="contentF"
