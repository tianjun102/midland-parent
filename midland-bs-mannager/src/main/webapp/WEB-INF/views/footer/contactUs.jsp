        ...
        <form id="formId" action="${ctx}/rest//contactUs/index" method="post" enctype="multipart/form-data"
            ...
            <ul class="adminfo row">
                ...
                <li id="textArea" style="display: block;">
                    <textarea style="width: 92%;min-height: 350px;resize:none; outline-color: #0099e0;" name="aboutUs"
                              id="myEditor" rows="" cols="">${item.aboutUs}</textarea>
                </li>
                ...
                <ul class="adminfo row">
                    <li>
                        ...
                        <a style="margin-left: 20px"  href="${ctx}/rest/contantUs/index"
