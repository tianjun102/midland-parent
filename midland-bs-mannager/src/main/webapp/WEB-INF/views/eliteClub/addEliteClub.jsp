    ...
    <section class = "content">
        ...
        <form id="formId" action="${ctx}/rest/banner/addBanner" method="post" enctype="multipart/form-data" method="post">
            ...
            <ul class = "adminfo row">
                ...
                <li>
                    <span>活动时间：</span>
                    <input type="text" name="adTime" class="Wdate half" style="width: 180px!important;" id="time3" onFocus="WdatePicker({isShowClear:true,readOnly:true,dateFmt:'yyyy-MM-dd HH:mm:ss'})" />
                </li>
                <li><span>图片：</span>
                ...
                <li><span>图片说明：</span><input type="text" id="imgDesc" name="imgDesc"></li>
                <li><span>活动名称：</span><input type="text" id="adName" name="adName"></li>
