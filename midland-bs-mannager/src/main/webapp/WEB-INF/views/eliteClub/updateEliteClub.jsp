    ...
    <section class = "content">
        ...
        <form id="formId" action="${ctx}/rest/banner/addBanner" method="post" enctype="multipart/form-data" method="post">
            ...
            <ul class = "adminfo row">
                ...
                <li><span>城市：</span>
                    <select onchange="setCityName();" name="cityId" id="cityId" style="height: 38px;width: 180px; display: inline-table;border-radius: 4px;border: 1px solid #dbe2e6;">
                ...
                <li id="textArea" style=""><span>页面内容：</span><textarea style="width: 92%;min-height: 350px;resize:none; outline-color: #0099e0;float: right" name="detail" id="myEditor" rows="" cols="">${item.detail}</textarea></li>
