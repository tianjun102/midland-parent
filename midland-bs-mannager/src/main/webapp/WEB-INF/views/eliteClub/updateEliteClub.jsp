    ...
    <section class = "content">
        ...
        <form id="formId" action="${ctx}/rest/banner/addBanner" method="post" enctype="multipart/form-data" method="post">
            ...
            <ul class = "adminfo row">
                ...
                <li><span>城市：</span>
                    <select onchange="setCityName();" name="cityId" id="cityId" style="height: 38px;width: 180px; display: inline-table;border-radius: 4px;border: 1px solid #dbe2e6;" <c:if test="${empty isSuper}">disabled="disabled"</c:if>>
                ...
                <li>
                    <span>活动时间：</span>
                    <input type="text" name="adTime" class="Wdate half" style="width: 180px;!important;" id="time3" value="${item.adTime}" onFocus="WdatePicker({isShowClear:true,readOnly:true,dateFmt:'yyyy-MM-dd'})" />
                </li>
                <li><span>图片：</span>
                ...
                <li id="textArea" style=""><textarea style="width: 92%;min-height: 350px;resize:none; outline-color: #0099e0;float: right" name="detail" id="myEditor" rows="" cols="">${item.detail}</textarea></li>
        ...
        $.ajax({
            ...
            success: function (data) {
                if(data.state=="0"){
                    ...
                    setTimeout(function(){window.open("${ctx}/rest/eliteClub/index","contentF");},2000);
                } else {
