				...
				<ul class = "adminfo row">
					...
					<li id="textArea" style="display: block;">
						<textarea style="width: 92%;min-height: 350px;resize:none; outline-color: #0099e0;"  id="myEditor" rows="" cols=""
								  name="description">${items.description}</textarea>
					</li>
				</ul>
				<ul class = "adminfo row">
					<li>
						...
						<a style="margin-left: 20px" href="${ctx}/rest/loanType/descIndex" target="contentF" class="public_btn bg3" id="cancel">取消</a>
					</li>
				</ul>
			</form>
		</section>
