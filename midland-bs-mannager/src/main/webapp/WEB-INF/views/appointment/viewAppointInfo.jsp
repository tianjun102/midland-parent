...
<section class="content" style="border:none;">
    <form action="${ctx}/rest/appoint/update" method="post" id="appointInfoForm">
        <ul class="userinfo width-md row">
            ...
            <li class="col-md-5"><span>预约编号：</span>
                <input type="text" name="appointSn" disabled="disabled" id="appointSn" readonly="readonly" value="${appointment.appointSn}"/>
            </li>
            <li class="col-md-5"><span>预约时间：</span>
            ...
            <li class="col-md-5"><span>预约人：</span><input type="text" name="nickName"  disabled="disabled" id="nickName" onblur="notEmpty('nickName','nickName','')"
                                                        value="${appointment.nickName}"/>
                <span class="_star">*</span>
            </li>
            <li class="col-md-5"><span>手机号码：</span><input type="text" name="phone"  disabled="disabled" id="phone" onblur="checkPhone('','phone','')"
                                                          value="${appointment.phone}"
                                                          maxlength="50"/><span class="_star">*</span></li>
            <li class="col-md-5"><span>分类：</span>
                <select name="sellRent" id="sellRent"  disabled="disabled" class="dropdown" style="background-color:  #ebebe4 ;">
            ...
            <li class="col-md-5"><span>预约类型：</span>
            ...
            <li class="col-md-5"><span>区域：</span><input type="text"  disabled="disabled" name="areaName" id="areaName" value="${appointment.areaName}"/>
            </li>
            <li class="col-md-5"><span>小区：</span><input type="text" name="communityName"  disabled="disabled" id="communityName"
                                                        value="${appointment.communityName}" maxlength="50"/>
            <li class="col-md-5"><span>地址：</span><input type="text"  disabled="disabled" name="address" id="address"
                                                        value="${appointment.address}"/>
            </li>
            <li class="col-md-5"><span>户型：</span><input type="text" name="layout"  disabled="disabled" id="layout"
                                                        value="${appointment.layout}"/>

            </li>
            <li class="col-md-5"><span>面积：</span><input type="text"  disabled="disabled" name="measure" id="measure"
                                                        value="${appointment.measure}"
                                                        maxlength="50"/>㎡</li>
            <li class="col-md-5"><span>装修：</span><input type="text"  disabled="disabled" name="decoration" id="decoration"
                                                        value="${appointment.decoration}"/>

            <li class="col-md-5"><span>状态：</span>
                <select name="status" id="status" class="dropdown"  disabled="disabled">
            ...
            <li class="col-md-11"><span>备注：</span>
                <textarea name="remark" id="remark"  disabled="disabled" style="width:calc(100% - 120px);height:50px;resize:none; border: 1px solid #dbe2e6; border-radius: 4px; outline-color: #0099e0;"></textarea>
            </li>
            </li>
