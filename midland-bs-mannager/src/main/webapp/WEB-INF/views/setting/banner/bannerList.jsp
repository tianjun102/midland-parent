...
<div class="table-responsive m40">
    <table class="table table-bordered table-add">
        ...
        <thead>
        <tr>
            <th><a target="contentF" href="javascript:void (0)" onclick="checkall()">全选</a> / <a target="contentF"
                                                                                                 href="javascript:void (0)"
                                                                                                 onclick="delcheckall()">取消</a>
            </th>
            <th>编号</th>
            <th>轮播图</th>
            <th>状态</th>
        ...
        <c:forEach items="${bannerList}" var="banner" varStatus="xh">
            <tr>
                ...
                <td>
                    ...
                    <a class="up_img" title="上移" target="contentF"
                       onclick="sort(${banner.id },${banner.orderBy},2)"></a>
                    <a class="down_img" title="下移" target="contentF"
                       onclick="sort(${banner.id },${banner.orderBy},1)"></a>
                    <a
                            <c:if test="${banner.enabled==1}">class="onoff_img"</c:if>
                            <c:if test="${banner.enabled==0}">class="offon_img"</c:if> target="contentF"
                            onclick="updateEnabled(${banner.enabled},${banner.id })"></a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
