...
<body>
	...
	<div class="box">
		...
		<form action="${ctx }/rest/comment/list" method="POST" id="searchForm"
			...
			<input style="width: 70px;height: 28px;line-height: 28px!important;" onclick="batchUpdate(0)" class = "public_btn bg1" type="submit"  value = "批量通过"/>
			<input style="margin-left: 20px;width: 70px;height: 28px;line-height: 28px!important;" onclick="batchUpdate(1)" class = "public_btn bg1" type="submit"  value = "批量拒绝"/>
