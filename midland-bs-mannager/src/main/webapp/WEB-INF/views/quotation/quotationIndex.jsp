...
<div class="box">
    <section class="content">
        ...
        <input style="margin-left: 20px;width: 70px;height: 28px;line-height: 28px!important;" onclick="window.open('${ctx}/rest/quotation/toolsTip_index','contentF')" class = "public_btn bg1" type="submit"  value = "生成预览"/>
        <div id="listDiv"></div>
