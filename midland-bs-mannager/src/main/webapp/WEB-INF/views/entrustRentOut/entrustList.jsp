...
<script type="text/javascript">
    ...
    function toUpdateEntrust(appointId) {
        ...
        var pageSize = ${paginator.limit};
        var param = "&pageNo="+pageNo+"&pageSize="+pageSize;
        window.open("${ctx}/rest/entrust/rentOut/to_update?entrustId=" + appointId +param, "contentF");
        ...
        <%--layer.open({--%>
            ...
            <%--shade: 0.3,--%>
            <%--area: ['1000px', '500px'],--%>
            <%--content: ['${ctx}/rest/entrust/rentOut/to_update?entrustId=' + appointId +param, 'yes']--%>
        <%--});--%>
    }
