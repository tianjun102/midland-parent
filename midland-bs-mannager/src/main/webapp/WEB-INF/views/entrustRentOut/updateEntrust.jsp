    ...
    <form action="${ctx}/rest/entrust/rentOut/update" method="post" id="appointInfoForm">
        <ul class="userinfo row">
            ...
            <li class="col-md-6"><span>小区：</span>
                <input type="text" name="communityName" id="communityName" disabled="disabled"  onblur="notEmpty('communityName','communityName','')"  value="${entrust.communityName}" maxlength="50"/></li>
            ...
            <li class="col-md-6"><span>面积：</span>
                <input type="text" name="measure" id="measure"  disabled="disabled" onblur="notEmpty('measure','measure','');InitInput.setNumber(this,9,2,2)" value="${entrust.measure}" maxlength="50"/>㎡</li>
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.state == 0) {
                    ...
                    setTimeout(function () {
                        window.open('${ctx}/rest/entrust/rentOut/index'+param,'contentF');
                    }, 1000);
