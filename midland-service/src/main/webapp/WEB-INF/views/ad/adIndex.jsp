...
<html lang="en" class="no-js">
	...
	<script type="text/javascript" src="${ctx}/assets/My97DatePicker/WdatePicker.js"></script>
      	<!--活动管理界面-->
	<div class="box"> 
	<form id="searchForm" action="${ctx}/rest/ad/list" method="post" onsubmit="submitSearchRequest('searchForm','listDiv');return false;">
		<section class = "content">
			<p class = "detail-title">
				<span>广告管理</span>
				<a class = "setup" href="${ctx}/rest/ad/enterAd" target="contentF">广告发布</a>
			</p>
			<ul class = "userinfo row">
				<li><span>广告标题：</span><input maxlength="50" type="text" name="adName" id="" placeholder="" /></li>
				<li>
					<span style = "float:left;">广告状态：</span>
    	...
    	layer.open({
			  ...
			  content:
				 	'<section class = "content" style = "border:none; height:100%;">'+
						'<p style = "text-align: center; font-size:16px; color:#000; margin-top:30px;">您确定要删除当前广告吗?</p>'+
					'</section>',
			  btn:['确定','取消'],
			  yes: function(index){
				  $.ajax({ 
						type: "post", 
						url: "${ctx}/rest/ad/deleteAd?adId="+id,
						cache:false, 
						async:false, // 此处必须同步
						dataType: "json",
