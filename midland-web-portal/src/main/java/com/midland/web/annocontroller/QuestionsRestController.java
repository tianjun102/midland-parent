...
public class QuestionsRestController extends ServiceBaseFilter {
    ...
    public Object getQuestionsById(@RequestBody Map map) {
        ...
        try {
            ...
            metaResult.setWebsiteDescription(temp.getQuestionsArea());
            metaResult.setWebsiteTitle(temp.getQuestionsTitle());
            metaResult.setWebsiteKeyWords("");
            result.setMeta(metaResult);
            result.setCode(ResultStatusUtils.STATUS_CODE_200);
            result.setMsg("success");
